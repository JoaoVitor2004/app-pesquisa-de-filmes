  ...
  return (
    <Box m={"auto"} mt={"8"} maxWidth={"90%"}>
      ...
      <Flex className={styles.search} m={"auto"} width={"500px"} maxWidth={"90%"} align={"center"} gap={"3"} p={"4"} px={"5"} mb={"6"}>
        ...
        <input value={input} onChange={(ev) => getValue(ev.currentTarget.value)} className={styles.input} name="movie" id="movie" placeholder="Digite o nome do filme" />
      </Flex>
      <CardMovie/>
    </Box>
  )
